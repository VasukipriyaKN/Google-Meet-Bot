...
def msg():
    ...
    account_sid = '<ACCOUNT SID>'                                                        # FILL ACCOUNT SID HERE
    auth_token = '<TOKEN>'                                                           # FILL AUTHENTICATION TOKEN HERE
    ...
    message = client.messages.create(
        from_='<CONTACT NO.>',                                            # FILL SENDERS CONTACT NUMBER HERE
        body='<MESSAGE>',                                              # FILL THE MESSAGE WHICH YOU WANT RECEIVE HERE
        to='<CONTACT NO.>'                                                 # FILL RECEIVERS CONTACT NUMBER HERE
    )
    print(message.sid)
...
time.sleep(6)
pyautogui.write("<EMAIL ID>")                                 # FILL YOUR MAIL ID HERE
pyautogui.press("enter")
time.sleep(2.5)
pyautogui.write("<PASSWORD>")                                # FILL YOUR PASSWORD HERE
pyautogui.press("enter")
time.sleep(7)
pyautogui.press("enter")
time.sleep(10)
...
pyautogui.click(x=1310, y=600)
                                                               # SOMETIMES THIS VALUE CAN CHANGE BASED ON SCREEN SIZE
time.sleep(5)
...
# TYPE ON WHAT WORDS YOU WANT TO GET NOTIFIED
if (element.get_attribute('innerHTML') == "<YOUR NAME OR ROLL NUM>"):
    automsg()
